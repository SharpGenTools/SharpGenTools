...
namespace SharpGen.Platform.Clang.XML
{
    internal partial class XmlOutputBuilder
    {
        ...
        {
            _sb.Append($"<enumeration name=\"{desc.EscapedName}\" access=\"{desc.AccessSpecifier.AsString()}\">");
            _sb.Append($"<type>{desc.TypeName}</type>");
        }
